...
public class ReadComments extends ListActivity {
	...
	// Progress Dialog
	private ProgressDialog pDialog;int pos=0;
   ...
   // private static final String READ_COMMENTS_URL = "http://xxx.xxx.x.x:1234/webservice/comments.php";
    ...
    //testing on Emulator:
    private static final String READ_COMMENTS_URL = "http://dbdemo.webuda.com/comments.php";
    ...
    private void updateList() {
    	// For a ListActivity we need to set the List Adapter, and in order to do
    			...
    			ListAdapter adapter = new SimpleAdapter(this, mCommentList,
    					R.layout.single_post, new String[] { TAG_MESSAGE,
    							TAG_USERNAME }, new int[] {  R.id.message,
    							R.id.username });
    			...
    			//to do nothing...
    			ListView list = getListView();	list.setClickable(true);
